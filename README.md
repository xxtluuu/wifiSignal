...
## 项目概述
WiFi信号测试器是一款基于 Flutter 框架开发的移动端应用，专注于测量当前连接 WiFi 网络的信号强度。应用支持实时信号强度监测，特别适用于测试用户在室内移动时的信号变化，并支持 Mesh 网络下多节点的信号识别。
...
### 5. 设备扫描与管理
- 扫描局域网中的在线设备，显示 IP 和 MAC 地址
- 标注未知设备，帮助识别非法接入
- 支持对设备进行简单的控制，如断开连接（需支持路由器管理接口）
